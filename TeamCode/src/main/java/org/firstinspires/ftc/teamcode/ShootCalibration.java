...
@TeleOp(name="Shoot Calibration", group="Calibration")
public class ShootCalibration extends OpMode {
    ...
    public void loop() {
        ...
        // shoot motors & servos
            if (-hwchasis.shootPower.getVelocity() < power){
        ...
        telemetry.addData("motorSpeed through AT transitor",          "%.2f", power);
